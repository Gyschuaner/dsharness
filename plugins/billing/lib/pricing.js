...
export function isPeakBeijing(timestamp) {
    const parts = beijingDateParts(timestamp);
...
export function estimatePrice(model, timestamp, usage) {
    ...
    const estimatedCost = (usage.inputTokens * rates.input
