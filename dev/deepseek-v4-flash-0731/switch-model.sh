...
case "$TARGET" in
  Qwen3.8-Flash-Next-FP8|Qwen3.8-27B-FP8|DeepSeek-V4-Flash-0731-Q4_K_XL|DeepSeek-V4-Flash-0731-Q8_K_XL) ;;
...
for screen_name in \
  ...
  deepseek_v4_server \
  exp_model_ccc8_dspark3_default \
  qwen38_flash_next_fp8_prod \
  qwen38_sglang_prod \
...
case "$TARGET" in
  Qwen3.8-Flash-Next-FP8)
    /data1/gys/qwen38-flash-next/scripts/launch-qwen38-flash-next-fp8.sh
    ;;
  Qwen3.8-27B-FP8)
  ...
  DeepSeek-V4-Flash-0731-Q8_K_XL)
    /data1/gys/qwen38-flash-next/scripts/launch-deepseek-q8-saved.sh
    ;;
esac
